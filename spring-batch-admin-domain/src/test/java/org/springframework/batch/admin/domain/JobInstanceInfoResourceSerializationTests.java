...
public class JobInstanceInfoResourceSerializationTests extends AbstractSerializationTests<JobInstanceInfoResource> {
    ...
    public void assertJson(String json) throws Exception {
        ...
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].createDate").assertValue(json,
                "1969-12-31T18:00:00.000-06:00");
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].endTime").assertValue(json,
                "1969-12-31T18:00:02.000-06:00");
        ...
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].exitStatus.exitDescription").assertValue(json,
                "Exit Description");
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].exitStatus.running").assertValue(json, false);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].jobConfigurationName").assertValue(json,
                "configName.xml");
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].jobId").assertValue(json, 1);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].jobParameters.parameters['foo'].identifying")
                .assertValue(json, true);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].jobParameters.parameters['foo'].type").assertValue(json,
                "STRING");
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].jobParameters.parameters['foo'].value").assertValue(json,
                "bar");
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].lastUpdated").assertValue(json,
                "1969-12-31T18:00:03.000-06:00");
        ...
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].startTime").assertValue(json,
                "1969-12-31T18:00:01.000-06:00");
        ...
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].stepExecutions[1].[0].processSkipCount")
                .assertValue(json, 0);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].stepExecutions[1].[0].readCount").assertValue(json, 0);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].stepExecutions[1].[0].readSkipCount").assertValue(json,
                0);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].stepExecutions[1].[0].rollbackCount").assertValue(json,
                0);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].stepExecutions[1].[0].stepName").assertValue(json,
                "step1");
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].stepExecutions[1].[0].terminateOnly").assertValue(json,
                false);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].stepExecutions[1].[0].writeCount").assertValue(json, 0);
        new JsonPathExpectationsHelper("$.jobExecutions[1].[0].stepExecutions[1].[0].writeSkipCount").assertValue(json,
                0);
    }
    ...
    public void assertObject(JobInstanceInfoResource jobInstanceInfoResource) throws Exception {
        ...
        assertEquals(new ExitStatus("COMPLETE", "Exit Description"),
                jobInstanceInfoResource.getJobExecutions().get(0).getExitStatus());
    }
    ...
    public JobInstanceInfoResource getSerializationValue() {
        ...
        JobExecution jobExecution = new JobExecution(jobInstance, 2l,
                new JobParametersBuilder().addString("foo", "bar").toJobParameters(), "configName.xml");
        ...
        JobExecutionInfoResource jobExecutionInfoResource = new JobExecutionInfoResource(jobExecution,
                TimeZone.getTimeZone("America/Chicago"));
        jobExecutionInfoResource.setStepExecutions(
                Arrays.asList(new StepExecutionInfoResource(stepExecution, TimeZone.getTimeZone("America/Chicago"))));
