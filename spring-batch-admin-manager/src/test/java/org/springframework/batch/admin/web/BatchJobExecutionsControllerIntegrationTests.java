...
public class BatchJobExecutionsControllerIntegrationTests extends AbstractControllerIntegrationTest {
    ...
    public void before() throws Exception {
        ...
        execution1 = new JobExecution(jobInstance1, 3l,
                new JobParametersBuilder().addString("param1", "test").addLong("param2", 123l, false).toJobParameters(),
                null);
        execution1.setLastUpdated(new Date());
        execution2 = new JobExecution(jobInstance2, 0l,
                new JobParametersBuilder().addString("param1", "test").addLong("param2", 123l, false).toJobParameters(),
                null);
    ...
    public void testGetJobExecutionsByName() throws Exception {
        ...
        mockMvc.perform(
                get("/batch/executions").param("jobname", "job1").param("startJobInstance", "0").param("pageSize", "20")
                        .accept(
    ...
    public void testGetSingleBatchJobExecution() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.jobExecutionInfoResource.jobParameters.parameters.param1.type",
                        Matchers.is("STRING")))
                .andExpect(jsonPath("$.jobExecutionInfoResource.jobParameters.parameters.param1.identifying",
                        Matchers.is(true)))
                .andExpect(jsonPath("$.jobExecutionInfoResource.jobParameters.parameters.param1.value",
                        Matchers.is("test")))
                .andExpect(jsonPath("$.jobExecutionInfoResource.jobParameters.parameters.param2.type",
                        Matchers.is("LONG")))
                .andExpect(jsonPath("$.jobExecutionInfoResource.jobParameters.parameters.param2.identifying",
                        Matchers.is(false)))
                .andExpect(
                        jsonPath("$.jobExecutionInfoResource.jobParameters.parameters.param2.value", Matchers.is(123)))
    ...
    public void testGetNonExistingBatchJobExecution() throws Exception {
        when(jobService.getJobExecution(99999l))
                .thenThrow(new NoSuchJobExecutionException("Could not find jobExecution with id 99999"));
