...
public class BatchStepExecutionsControllerIntegrationTests extends AbstractControllerIntegrationTest {
    ...
    public void testGetBatchStepExecutionsNotExists() throws Exception {
        ...
        mockMvc.perform(get("/batch/executions/{executionId}/steps", "5555")).andDo(print())
    ...
    public void testGetSingleBatchStepExecution() throws Exception {
        JobExecution jobExecution = new JobExecution(2l,
                new JobParametersBuilder().addString("param1", "test").addLong("param2", 123l).toJobParameters());
        jobExecution.setLastUpdated(new Date());
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.stepExecutionInfoResource.executionContext['contextTestKey']",
                        Matchers.is("someValue")));
    }
    ...
    public void testGetBatchStepExecutionProgress() throws Exception {
        ...
        JobExecution jobExecution = new JobExecution(jobInstance, 2l,
                new JobParametersBuilder().addString("param1", "test").addLong("param2", 123l).toJobParameters(), null);
        jobExecution.setLastUpdated(new Date());
        StepExecution execution = new StepExecution("step1", jobExecution, 1l);
        execution.setLastUpdated(new Date());
        ...
        when(jobService.listStepExecutionsForStep("job1", "step1", 0, 1000))
                .thenReturn(Arrays.asList(new StepExecution("step1", new JobExecution(5l))));
    ...
    public void testGetProgressForJobExecutionNotExists() throws Exception {
        ...
        mockMvc.perform(get("/batch/executions/{jobExecutionId}/steps/{stepExecutionId}/progress", "5555", "2"))
                .andExpect(
                        status().isNotFound())
                .andExpect(
                        jsonPath("$.message",
    ...
    public void testGetProgressForStepExecutionNotExists() throws Exception {
        ...
        mockMvc.perform(get("/batch/executions/{jobExecutionId}/steps/{stepExecutionId}/progress", "3", "5555"))
                .andExpect(
                        status().isNotFound())
                .andExpect(
                        jsonPath("$.message",
