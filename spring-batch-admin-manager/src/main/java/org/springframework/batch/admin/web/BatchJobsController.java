...
/**
 * Controller for batch jobs and job instances, job executions on a given batch
 * job.
 * 
 * @author Dave Syer
...
public class BatchJobsController extends AbstractBatchJobsController {
    ...
    /**
     * Get the paged resources of
     * {@link org.springframework.batch.admin.domain.DetailedJobInfoResource}
     * 
     * @param pageable  the paging metadata
     * @param assembler the paged resource assembler of type
    ...
    public PagedModel<DetailedJobInfoResource> jobs(Pageable pageable,
    ...
    private DetailedJobInfoResource getJobInfoResource(String jobName) {
        return jobInfoResourceAssembler.toModel(getJobInfo(jobName));
    }
